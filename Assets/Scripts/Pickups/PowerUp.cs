...
public class PowerUp : MonoBehaviour
{
    ...
    public GameObject healthBuffOn;
    ...
    */
    void Update()
    {
        //setBuffAlert();
                ...
                if (playerHealth.healthBuffed == true && timerUp == false)
                {
					
                    playerHealth.currentHealth = 1000;
            healthBuffOn.SetActive(true);
    ...
    void OnTriggerEnter(Collider other)
	{
		...
		if (other.gameObject.CompareTag ("Player")) {
			...
			GameObject Gma = GameObject.Find ("Gma");
			PlayerHealth playerHealth = Gma.GetComponent<PlayerHealth> ();
			//playerHealth.currentHealth = 100;
			healthItem++;
			//NoDamage();
